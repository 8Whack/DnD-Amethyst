...
// CODE HERE
uniq(names, result =>{
  console.log('The new names array with all the duplicate items removed is ' + result)
...
// CODE HERE
each(names, (index, name2) => {
  console.log ('The item at index ' + index + 'is ' + name2)
})
